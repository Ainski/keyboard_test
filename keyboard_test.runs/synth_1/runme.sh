...
HD_PWD='E:/model/keyboard_test/keyboard_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log keyboard_top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source keyboard_top.tcl
